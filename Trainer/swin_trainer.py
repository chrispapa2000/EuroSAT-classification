...
class SwinTrainer(ResNetTrainer):
    """Swin Trainer - same as ResNet Trainer except for build_model()"""
    ...
    def build_model(self) -> nn.Module:
        ...
        assert arch == "Swin", "This is a Swin trainer but the requested architecture is not Swin!"
        
        param_dict = parse_model_config(model_cfg)
        
        model = SwinTransformer(**param_dict)
